...
_SCRIPT_FONTS: dict[str, list[tuple[str, list[str]]]] = {
    "latin": [
        ("notosans", ["NotoSans[wdth,wght].ttf", "NotoSans[wght].ttf"]),
        ("notoserif", ["NotoSerif[wdth,wght].ttf", "NotoSerif[wght].ttf"]),
    ],
    "greek": [("notosans", ["NotoSans[wdth,wght].ttf", "NotoSans[wght].ttf"])],
    "cyrillic": [("notosans", ["NotoSans[wdth,wght].ttf", "NotoSans[wght].ttf"])],
    "armenian": [("notosansarmenian", ["NotoSansArmenian[wdth,wght].ttf", "NotoSansArmenian[wght].ttf"])],
    "hebrew": [("notosanshebrew", ["NotoSansHebrew[wdth,wght].ttf", "NotoSansHebrew[wght].ttf"])],
    "arabic": [("notosansarabic", ["NotoSansArabic[wdth,wght].ttf", "NotoSansArabic[wght].ttf"])],
    "syriac": [("notosanssyriac", ["NotoSansSyriac[wght].ttf"])],
    "devanagari": [("notosansdevanagari", ["NotoSansDevanagari[wdth,wght].ttf", "NotoSansDevanagari[wght].ttf"])],
    "bengali": [("notosansbengali", ["NotoSansBengali[wdth,wght].ttf", "NotoSansBengali[wght].ttf"])],
    "gurmukhi": [("notosansgurmukhi", ["NotoSansGurmukhi[wdth,wght].ttf", "NotoSansGurmukhi[wght].ttf"])],
    "gujarati": [("notosansgujarati", ["NotoSansGujarati[wdth,wght].ttf", "NotoSansGujarati[wght].ttf"])],
    "oriya": [("notosansoriya", ["NotoSansOriya[wght].ttf"])],
    "tamil": [("notosanstamil", ["NotoSansTamil[wdth,wght].ttf", "NotoSansTamil[wght].ttf"])],
    "telugu": [("notosanstelugu", ["NotoSansTelugu[wdth,wght].ttf", "NotoSansTelugu[wght].ttf"])],
    "kannada": [("notosanskannada", ["NotoSansKannada[wdth,wght].ttf", "NotoSansKannada[wght].ttf"])],
    "malayalam": [("notosansmalayalam", ["NotoSansMalayalam[wdth,wght].ttf", "NotoSansMalayalam[wght].ttf"])],
    "sinhala": [("notosanssinhala", ["NotoSansSinhala[wdth,wght].ttf", "NotoSansSinhala[wght].ttf"])],
    "thai": [("notosansthai", ["NotoSansThai[wdth,wght].ttf", "NotoSansThai[wght].ttf"])],
    "lao": [("notosanslao", ["NotoSansLao[wdth,wght].ttf", "NotoSansLao[wght].ttf"])],
    "tibetan": [("notoseriftibetan", ["NotoSerifTibetan[wght].ttf"])],
    "myanmar": [("notosansmyanmar", ["NotoSansMyanmar[wght].ttf"])],
    "georgian": [("notosansgeorgian", ["NotoSansGeorgian[wdth,wght].ttf", "NotoSansGeorgian[wght].ttf"])],
